defmodule ElixirOfLife.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ElixirOfLife.MyChannel do
        use ElixirOfLife.Web, :channel
        alias ElixirOfLife.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :elixir_of_life,
                        pubsub_server: ElixirOfLife.PubSub
end
