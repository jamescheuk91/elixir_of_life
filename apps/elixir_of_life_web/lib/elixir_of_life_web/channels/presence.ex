defmodule ElixirOfLifeWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ElixirOfLifeWeb.MyChannel do
        use ElixirOfLifeWeb, :channel
        alias ElixirOfLifeWeb.Presence
