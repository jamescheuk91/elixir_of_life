defmodule ElixirOfLife.Board do
  ...
  def next_generation(%ElixirOfLife.Board{} = board) do
    ...
    next_alive_cell_colors = next_generation_alive_cell_colors(current_alive_cell_colors, current_alive_cells, next_alive_cells)
    %{board | generation: board.generation + 1, alive_cells: next_alive_cells, alive_cell_colors: next_alive_cell_colors}
  end
  ...
  def next_generation_alive_cell_colors(%{} = current_alive_cell_colors, %MapSet{} = current_alive_cells, %MapSet{} = next_alive_cells) do
