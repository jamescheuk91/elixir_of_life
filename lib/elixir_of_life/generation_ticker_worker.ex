defmodule ElixirOfLife.GenerationTickerWorker do
  require Logger
  ...
  def start_link() do
    init_ticker = %GenerationTickerWorker{}
    case GenServer.start_link(__MODULE__, init_ticker, [name: @default_name]) do
      {:ok, pid} ->
